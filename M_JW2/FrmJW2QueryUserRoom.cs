...
namespace M_JW2
{
    [C_Global.CModuleAttribute("玩家登陆房间记录查询", "FrmJW2QueryUserRoom", "玩家登陆房间记录查询", "AU Group")] 
    public partial class FrmJW2QueryUserRoom : Form
    {
        ...
        {
            //创建登录窗体
            FrmJW2QueryUserRoom mModuleFrm = new FrmJW2QueryUserRoom();
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {
                //e.Result = Operation_Audition.GetResult(m_ClientEvent, CEnum.ServiceKey.AU_UserLinkStat_Query, (CEnum.Message_Body[])e.Argument);
            }
        }
        ...
        private void FrmJW2QueryUserRoom_Load(object sender, EventArgs e)//////////////////////
        {
            try
            {
                this.listView1.Columns.Add("序號");
                this.listView1.Columns.Add("頻道", 100);
                this.listView1.Columns.Add("頻道人次", 100);
