...
namespace C_Socket
{
	...
	public class TLV_Structure
	{
		...
		public byte[] ToByteArray()
		{
            ...
            temp[2] = (byte)(this.m_uiValueLen / 255);
            temp[3] = (byte)(this.m_uiValueLen % 255);
		...
		public string toString() 
		{
			if ( this.m_bValueBuffer == null|| this.m_bValueBuffer.Length == 0 )
				return "";
            //return System.Text.Encoding.Unicode.GetString(m_bValueBuffer);
		...
		public static byte[] ValueToByteArray(C_Global.CEnum.TagFormat tagformat,object val)
		{
			switch(tagformat)
			{
				...
				case C_Global.CEnum.TagFormat.TLV_EXTEND:
				{
					...
					else if (((Packet_Body)val).m_Status != C_Global.CEnum.Body_Status.MSG_STRUCT_OK)
						throw new ValueException(((Packet_Body)val).m_Status.ToString(),C_Global.CEnum.Body_Status.MSG_STRUCT_OK.ToString());
